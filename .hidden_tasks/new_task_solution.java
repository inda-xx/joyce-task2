...
class Spacecraft {
    ...
    public void explore(String newPlanet) {
        double fuelNeeded = 10.0; // Assume each trip costs 10% fuel for simplicity
        if (fuelLevel >= fuelNeeded) {
            fuelLevel -= fuelNeeded;
            currentPlanet = newPlanet;
            System.out.println(name + " is exploring " + newPlanet + "!");
            System.out.println("Fuel Level now at: " + fuelLevel + "%");
        } else {
            System.out.println("Not enough fuel to explore " + newPlanet + ".");
        }
    }
